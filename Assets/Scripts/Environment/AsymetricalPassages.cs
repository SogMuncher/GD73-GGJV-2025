...
public class AsymetricalPassages : MonoBehaviour
{
    ...
    [SerializeField] private Transform _bottomOfTrigger;
    [SerializeField] private Transform _topOfTrigger;
    ...
    private void Start()
    {
        _perimeterOfTrigger = _topOfTrigger.localPosition.y - _bottomOfTrigger.localPosition.y;
    }
    ...
    public void GetHits()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(_bottomOfTrigger.position, Vector2.up, _maxDistance, _rayLayerMask);
        ...
        {
            float distance = Mathf.Abs(hit.point.y - _bottomOfTrigger.position.y);
            Debug.Log(distance);
    ...
    private void OnDrawGizmos()
    {
        ...
        Debug.DrawRay(_bottomOfTrigger.position, Vector2.up * 10, Color.black);
    }
